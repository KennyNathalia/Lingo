...
function check() {
    ...
    for (var i = 0; i < 5; i++) {
        ...
        for (var a = 0; a < 5; a++) {
            if (inputWord[i] == randomWord[a]) {
                if (i == a && letters[i]['isGuessed'] == false) {
                    guess[i].style.backgroundColor = "green";
                    guess[i].style.borderRadius = "50%";
                    letters[i].isGuessed = true;
                } 
            }   else if(letters[i].isGuessed == false) {
                    guess[i].style.backgroundColor = "red";
                    guess[i].style.borderRadius = "50%";
                }
                if(counter == 25){
